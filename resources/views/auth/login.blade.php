<x-guest-layout>
    ...
    <div>
        <div class="absolute inset-0">
            <img src="{{ asset('assets') }}/images/kue.jpeg" alt="image" class="h-full w-full bg-cover ">
        </div>
                        ...
                        <form class="space-y-5 dark:text-white" method="POST" action="{{ route('login') }}">
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="Nik" type="text" name="nik" placeholder="Enter Nik" class="form-input ps-10 placeholder:text-white-dark">
                            ...
                            <div>
                                <label class="flex cursor-pointer items-center">
                                    <input id="remember_me" name="remember" type="checkbox" class="form-checkbox bg-primary dark:bg-black">
                                    <span class="text-white-dark">Remember me</span>
                                </label>
                            </div>
                            <button type="submit" class=" text-white btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]">
                                Sign in
                            </button>
                        </form>
                        <div class="relative my-7 text-center md:mb-9">
                            <span class="absolute inset-x-0 top-1/2 h-px w-full -translate-y-1/2 bg-white-light dark:bg-white-dark"></span>
                            <span class="relative bg-white px-2 font-bold uppercase text:dark:text-white-dark">or</span>
                        </div>
                        <div class="mb-10 md:mb-[60px]">
                            <ul class="flex justify-center gap-3.5">
                                <li>
                                    <a href="/" class="inline-flex items-center justify-center rounded-full p-0 transition hover:scale-110">
                                       <--- Back Home Page
                                    </a>
                                </li>
                            </ul>
