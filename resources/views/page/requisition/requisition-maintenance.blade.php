<x-app-layout>
                    ...
                    <section>
                        <div class="grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-x-4">
                            ...
                            <div class="mb-1" style="display: none;">
                                ...
                                <input type="text" value="{{ Auth::user()->username }}" name="enterby"
                                    class="bg-gray-200 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    id="enterby" readonly>
                            </div>
                            <div class="mb-1">
                        ...
                        <div class="grid grid-cols-2 gap-x-4">
                            ...
                            <div>
                                ...
                                <div class="mb-1">
                                    <input type="hidden" id="rqmRqbyUserid" value="mfg" name="rqmRqbyUserid"
                                        class="bg-gray-200 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                </div>
                            ...
                            <div>
                                <div class="form-group relative mb-1">
                                    <label for="subaccount" class="block mb-2 text-md font-medium">Sub
                                        Account:</label>
                                    <div class="relative">
                                ...
                                <div class="mb-1">
                                    <label for="remarks" class="block mb-2 text-md font-medium">Remarks:</label>
                                ...
                                <div class="mb-1">
                                    <input type="hidden" value="1" id="rqmExRate2" name="rqmExRate2">
                                </div>
                        ...
                        <div id="lineItemsContainer">
                            ...
                            <div class="lineItem" data-row-id="1">
                                <div class="grid grid-cols-6 md:grid-cols-6 gap-2">
                                    ...
                                    <div class="form-group">
                                        <label for="reqQty" class="block text-md font-medium">Req Qty: <span
                                                class="text-danger">*</span></label>
                                        <input type="text" id="reqQty" value="" name="rqdReqQty[]"
                                            placeholder="0"
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="relative">
                                                <input type="text" id="rqdUm" name="rqdUm[]"
                                                    class="rqdUm bg-gray-200 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 w-1/3"
                                                    disabled>
                                                <select id="umDropdown" name="umDropdown[]"
                                                    class="bg-gray-200 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 w-2/3"
                                                    disabled>
                                                    <option value=" ">Select UM</option>
                                                    <option value="BO">BO - BOTTLE</option>
                                                    <option value="BT">BT - BATANG</option>
                                                    <option value="CT">CT - Carton</option>
                                                    <option value="DR">DR - Drum</option>
                                                    <option value="FX">FX - FLEXI</option>
                                                    <option value="HR">HR - Hour(s)</option>
                                                    <option value="JR">JR - Jerrycan</option>
                                                    <option value="KG">KG - Kilogram</option>
                                                    <option value="KL">KL - KALENG</option>
                                                    <option value="LB">LB - LEMBAR</option>
                                                    <option value="LT">LT - Liter</option>
                                                    <option value="M3">M3 - Meter Cubic</option>
                                                    <option value="MT">MT - Meter Length</option>
                                                    <option value="PC">PC - Piece(s)</option>
                                                    <option value="PL">PL - Pail</option>
                                                    <option value="RL">RL - ROLL</option>
                                                    <option value="RO">RO - ROLL</option>
                                                    <option value="SE">SE - Set(s)</option>
                                                    <option value="TB">TB - TABUNG</option>
                                    ...
                                    <div class="form-group">
                                        <label for="unitCost" class="block text-md font-medium">Unit Cost: <span
                                                class="text-danger">*</span></label>
                                        <input type="text" id="unitCost" name="rqdPurCost[]" placeholder="0"
                                ...
                                <div class="grid grid-cols-3 gap-4 mt-6 ">
                                    ...
                                    <div class="form-group relative mb-1">
                                        <label for="stockUMQty" class="block text-md font-medium">UM Conv:</label>
                                        <input type="text" id="stockUMQty" value="0" name="rqdUmConv[]"
                                            readonly
                                        ...
                                        <label for="maxUnitCost" class="block text-md font-medium mt-4">Maximum
                                            Unit
                                            Cost:</label>
                                        <input type="text" id="maxUnitCost" value="0" name="rqdMaxCost[]"
                                            readonly
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label for="maxExtCost" class="block text-md font-medium">Max Extended
                                                Cost:</label>
                                            <input type="text" id="maxExtCost" value="0"
                                            ...
                                            <label for="extCost" class="block text-md font-medium mt-4">Extended
                                                Cost:</label>
                                            <input type="text" id="extCost" value="0"
                                        ...
                                        <div class="relative overflow-x-auto">
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th scope="col"
                                                            class="border-b dark:border-slate-600 font-medium p-4 text-slate-500  text-lef">
                                                            Item Number
                                                        </th>
                                                        <th scope="col"
                                                            class="border-b dark:border-slate-600 font-medium p-4 text-slate-500  text-lef">
    ...
    @push('scripts')
        <script>
            ...
            // Berikan fokus ke elemen input saat halaman dimuat
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Update rqdNeedDate and rqdDueDate on initial load
                updateDynamicDates();

                // Add event listeners to needdate and duedate inputs
                needDateInput.addEventListener('input', updateDynamicDates);
                dueDateInput.addEventListener('input', updateDynamicDates);

                function updateDynamicDates() {
                    const needDateValue = needDateInput.value;
                    const dueDateValue = dueDateInput.value;

                    document.querySelectorAll('.rqdNeedDate').forEach(input => {
                        input.value = needDateValue;
                    });

                    document.querySelectorAll('.rqdDueDate').forEach(input => {
                ...
                function addLineItem() {
                    ...
                    const existingCheckboxContainer = lineItemTemplate.querySelector('.commentsCheckbox')
                        ?.parentNode;
                    ...
                    needDateInput.value = mainNeedDateInput ? mainNeedDateInput.value : new Date().toISOString()
                        .split(
                            'T')[0];
                ...
                function initializeDataTable(table) {
                    if ($.fn.DataTable.isDataTable(table)) {
                        table.DataTable().clear()
                            .destroy(); // Bersihkan dan hancurkan jika tabel sudah diinisialisasi
                    }
                    table.DataTable({
                        processing: true,
                        serverSide: false,
                ...
                $(document).ready(function() {
                    ...
                    function resetInput($lineItem) {
                        ...
                        $lineItem.find('input[id^="descItem"]').val('');
                    ...
                    function initializeSearch() {
                            ...
                            if (searchTerm.length >= 1) {
                                searchItems(query).done(function(data) {
                                    ...
                                    if (results.length === 1 && results[0].pt_part
                                        ...
                                        console.log('Selected UM:', selectedUm);
                                        console.log('rqdUm Input Value:', $rqdUmInput
                                            .val());
                                        console.log('Selected Desc:', selectedDesc);
                                        console.log('descItem Input Value:',
                                            $descItemInput
                                            .val());
                                    }
                                });
                        ...
                        $(document).on('click', '.searchResults li', function() {
                            ...
                            console.log('Selected UM:', selectedUm);
                            console.log('rqdUm Input Value:', $rqdUmInput.val());
                            console.log('Selected Desc:', selectedDesc);
                            console.log('descItem Input Value:', $descItemInput.val());
                        });
                                    ...
                                    if (rowToFill) {
                                        ...
                                        if (target === 'modal-item') {
                                            ...
                                            if (rowToFill.querySelector('.purracct')) {
                                                rowToFill.querySelector('.purracct')
                                                    .value =
                                                    row.getAttribute(
                                                        'data-supplier-code');
                                            }
                ...
                function updateRealTimeValues() {
                    ...
                    if (reqQtyInput && stockUMQtyInput && unitCostInput && maxUnitCostInput &&
                        ...
                        console.error(
                            'Some inputs are missing in the line item during real-time update:', {
                                reqQtyInput,
                                stockUMQtyInput,
                                unitCostInput,
                                maxUnitCostInput,
                ...
                if (allInfoCorrectCheckbox) {
                    updateHiddenInput(allInfoCorrectCheckbox, document.getElementById(
                        'allInfoCorrectCheckboxHidden'));
                }
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Set nilai awal dropdown mata uang
                document.getElementById('currency').value = initialCurrencyValue;
                ...
                document.getElementById('currency').addEventListener('change', function(event) {
                    ...
                    var exchangeRateInput = document.getElementById('rqmExRate2');
                    ...
                    if (selectedCurrency === initialCurrencyValue) {
                        ...
                        exchangeRateInput.value = '1'; // Set nilai exchange rate untuk IDR
                    } else {
                        ...
                        fetch('{{ route('check.curr') }}', {
                            ...
                            .then(data => {
                                if (data.error === 'true') {
                                    messageContainer.innerHTML =
                                        '<span class="text-green-600">Currency is available!</span>';
                                    exchangeRateInput.value = data.exchangeRate.replace(/\./g, ',');
                                } else {
                                    messageContainer.innerHTML =
                                    ...
                                    exchangeRateInput.value = '0'; // Reset nilai exchange rate
                                }
                            })
                            .catch(error => {
                                console.error('Error:', error);
    ...
    <div id="large-modal" tabindex="-1"
        class="fixed inset-0 z-50 flex items-center justify-center p-1 overflow-y-auto  bg-opacity-50 modal hidden"
        aria-hidden="true">
        <div class="relative w-full max-w-4xl max-h-full bg-white rounded-lg shadow-lg">
            <!-- Modal content -->
            <div class="relative">
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Ambil semua elemen input dan dropdown UM
                const umInputs = document.querySelectorAll('input[name="rqdUm[]"]');
                const umDropdowns = document.querySelectorAll('select[name="umDropdown[]"]');
                const itemNumberInputs = document.querySelectorAll('input[name="rqdPart[]"]');

                // Set input dan dropdown UM menjadi disabled saat awal
                umInputs.forEach(input => input.disabled = true);
                umDropdowns.forEach(dropdown => dropdown.disabled = true);

                itemNumberInputs.forEach((itemInput, index) => {
                    const umInput = umInputs[index];
                    const umDropdown = umDropdowns[index];

                    // Ketika item number berubah, periksa apakah ada nilai
                    itemInput.addEventListener('input', function() {
                        if (this.value.trim() !== '') {
                            // Jika item number diisi, periksa apakah ada nilai UM
                            if (umInput.value.trim() !== '') {
                                // Jika UM sudah didapat dari item number, nonaktifkan input dan dropdown UM
                                umInput.disabled = true;
                                umDropdown.disabled = true;
                            } else {
                                // Jika UM tidak didapat dari item number, aktifkan dropdown UM
                                umInput.disabled = true;
                                umDropdown.disabled = false;
                            }
                        } else {
                            // Jika item number dikosongkan, aktifkan kembali input dan dropdown UM
                            umInput.disabled = true;
                            umDropdown.disabled = false;
                        }
                    });

                    // Jika UM sudah ada dari item number, nonaktifkan dropdown UM
                    if (umInput.value.trim() !== '') {
                        umDropdown.disabled = true;
                    }
                });

                umInputs.forEach((input, index) => {
                    const dropdown = umDropdowns[index];

                    // Nonaktifkan input manual pada rqdUm
                    input.addEventListener('keydown', function(event) {
                        event.preventDefault();
                    });

                    // Ketika dropdown berubah, isi input dengan nilai yang dipilih
                    dropdown.addEventListener('change', function() {
                        input.value = this.value; // Masukkan nilai yang dipilih dari dropdown
                    });

                    // Ketika input berubah, kosongkan dropdown
                    input.addEventListener('input', function() {
                        if (this.value.trim() === '') {
                            dropdown.value = '';
                        }
