    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body wizard-content">
                <form id="form" name="form" method="POST" action="{{ route('rqm.update', ['rqmNbr' => $editRqm->rqmNbr]) }}"
                    ...
                    <section>
                        <div class="grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 gap-x-4">
                            <div class="mb-1">
                                ...
                                <input type="text" id="prNumberInput" name="prNumber" readonly value="{{ $editRqm->rqmNbr }}"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" value="{{ Auth::user()->name }}" name="enterby" value="{{ $editRqm->enterby }}"
                            ...
                            <div class="mb-1">
                                <input type="hidden" value="1000" id="site" name="rqmSite" value="{{ $editRqm->rqmSite }}">
                            </div>
                            <div class="mb-1">
                                <input type="hidden" value="1000" id="site" name="rqmShip" value="{{ $editRqm->rqmShip }}">
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-x-4">
                            ...
                            <div>
                                ...
                                <div class="mb-1">
                                    <input type="hidden" id="enterby" value="mfg" name="rqmRqbyUserid" value="{{ $editRqm->rqmRqbyUserid }}"
                                        class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                </div>
                                <div class="mb-1">
                                    <input type="hidden" id="requestby" name='requestby' value="mfg" value="{{ $editRqm->rqmRqbyUserid }}"
                                        class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                </div>
                                <div class="form-group relative mb-1">
                                ...
                                <div class="mb-1">
                                    <label for="enduser" class="block mb-2 text-sm font-medium">End User: <span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="enduser" name='rqmEndUserid' readonly value="{{ $editRqm->rqmEndUserid }}"
                                        class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                </div>
                            ...
                            <div>
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="reason" name="rqmReason" value="{{ $editRqm->rqmReason }}"
                                        class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                </div>
                                <div class="mb-1">
                                    <label for="remarks" class="block mb-2 text-sm font-medium">Remarks:</label>
                                    <input type="text" id="remarks" name="rqmRmks" value="{{ $editRqm->rqmRmks }}"
                                        class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                </div>
                                ...
                                <div class="mb-1">
                                    <input type="hidden" value="US" id="lang" name="rqmLang" value="{{ $editRqm->rqmLang }}">
                                </div>

                                <div class="mb-1">
                                    <input type="hidden" value="R" id="emailOption" name="emailOptEntry" value="{{ $editRqm->emailOptEntry }}">
                                </div>
                                <div class="mb-1">
                                    <input type="hidden" id="entity" value="SMII" name="rqmEntity" value="{{ $editRqm->rqmEntity }}">
                                </div>
                                <div class="mb-1">
                                    <input type="hidden" id="entity" name="rqmDirect" value="{{ $editRqm->rqmDirect }}">
                                </div>

                                <div class="mb-1">
                                    <label for="appstatus" class="block mb-2 text-sm font-medium">Approval
                                        Status:</label>
                                    <input type="text" id="appstatus" name="rqmAprvStat" value="{{ $editRqm->rqmAprvStat }}"
                                        class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                        readonly>
                                </div>
                                <div class="mt-4 flex items-center">
                                    <input type="checkbox" id="directCheckbox" class="rounded" name="rqmDirect" @checked($editRqm->rqmDirect == 'true')>
                                    <label for="directCheckbox" class="text-sm font-medium ml-2 text-black">Direct
                                        Material</label>
                                </div>
                                <div class="mt-4 flex items-center">
                                    <input type="checkbox" id="nonPOCheckbox" class="rounded" name="rqm__log01" @checked($editRqm->rqm__log01 == 'true')>
                            ...
                            @foreach($editRqm->rqdDets as $rqdDet)
                                ...
                                <div class="lineItem" data-row-id="row-{{ $loop->iteration }}">
                                    <div class="grid grid-cols-2 md:grid-cols-5 gap-4 ">
                                        ...
                                        <div class="form-group relative mb-1">
                                            <label for="supplieritem" class="block text-sm font-medium">Supplier:</label>
                                            <div class="relative">
                                        ...
                                        <div class="form-group">
                                            <label for="reqQty" class="block text-sm font-medium">Req Qty: <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" id="reqQty" name="rqdReqQty[]" value="{{ $rqdDet->rqdReqQty }}"
                                                placeholder="0"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="rqdUm" name="rqdUm[]" readonly value="{{ $rqdDet->rqdUm }}"
                                        ...
                                        <div class="form-group">
                                            <label for="unitCost" class="block text-sm font-medium">Unit Cost: <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" id="unitCost" name="rqdPurCost[]" value="{{ $rqdDet->rqdPurCost }}" placeholder="0"
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" id="discount" value="{{ $rqdDet->rqdDiscPct }}" name="rqdDiscPct[]"
                                    ...
                                    <div class="grid grid-cols-3 gap-4 mt-6 ">
                                        <div class="form-group relative mb-1">
                                            ...
                                            <div class="form-group relative mb-1">
                                                ...
                                                <div class="relative">
                                                    <input type="text" id="purracct" name="rqdAcct[]" value="{{ $rqdDet->rqdAcct }}"
                                        ...
                                        <div class="form-group relative mb-1">
                                            <label for="stockUMQty" class="block text-sm font-medium">Stock UM
                                                Qty:</label>
                                            <input type="number" id="stockUMQty" value="{{ $rqdDet->rqdUmConv }}" name="rqdUmConv[]" readonly
                                            ...
                                            <label for="maxUnitCost" class="block text-sm font-medium mt-4">Maximum
                                                Unit
                                                Cost:</label>
                                            <input type="number" id="maxUnitCost" value="{{ $rqdDet->rqdMaxCost }}" name="rqdMaxCost[]" class="bg-gray-200 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 maxUnitCost">
                                            <div class="target-insert-point">

                                            </div class='target-insert-point'>
                                            <div class="mt-4 flex items-center">
                                                <input type="checkbox" id="commentsCheckbox-row-{{ $loop->iteration }}"
                                                    class="rounded commentsCheckbox" name="lineCmmts[]"
                                                    data-row-id="row-{{ $loop->iteration }}" data-toggle="modal"
                                                    data-target="#commentsModal-row-{{ $loop->iteration }}" value="true" @checked($rqdDet->lineCmmts == 'true')>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label for="maxExtCost" class="block text-sm font-medium">Max Extended
                                                    Cost:</label>
                                                <input type="number" id="maxExtCost" value="{{ $rqdDet->maxExtCost }}"
                                                ...
                                                <label for="extCost" class="block text-sm font-medium mt-4">Extended
                                                    Cost:</label>
                                                <input type="number" id="extCost" value="{{ $rqdDet->extCost }}"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-input w-full required" id="routeto"
                                            name="routeToApr" aria-invalid="true" readonly value="{{ $editRqm->routeToApr }}">
                            ...
                            <div class="relative w-full max-w-4xl max-h-full bg-white rounded-lg shadow-lg">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="p-2 md:p-3 space-y-4">
                                        <textarea class="commentText" name="cmtCmmt[]"  value="{{ $rqdDet->rqdCmt }}" cols="30" rows="10" style="border: none; width: 100%;">{{ $rqdDet->rqdCmt }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
